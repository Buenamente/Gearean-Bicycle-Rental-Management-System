...
Public Class Form4
    Private connString As String = "Data Source=bicycle_rental.db;Version=3;Busy Timeout=5000;" ' 5 seconds
    ...
    Private Function GetCurrentRentalRate() As Double
        Using conn As New SQLiteConnection(connString)
            ...
            Return 20.0 ' Default rate if no rate is found
        End Using
    End Function
    ...
    Private Sub CalculateTotalFees()
        ...
        Dim rentalRate As Double = GetCurrentRentalRate() ' Dynamically get current rate
            ...
            Using transaction As SQLiteTransaction = conn.BeginTransaction()
                Try
                    ...
                    Dim rentalDetails As String = $"Rental ID: {rentalID}" & Environment.NewLine &
                                                  ...
                                                  $"Rental Rate: PHP {rentalRate:F2} per hour" & Environment.NewLine &
